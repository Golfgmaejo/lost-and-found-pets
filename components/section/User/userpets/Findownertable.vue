  ...
  methods: {
    async fetchPetList() {
      ...
      try {
        const response = await axios.get(
          `https://lost-and-found-pets-backend.onrender.com/api/find_owner/get_find_owner_by_user_id/${userId}`
        );
    ...
    async deleteItemConfirm() {
      try {
        ...
        await axios.delete(
          `https://lost-and-found-pets-backend.onrender.com/api/find_owner/delete_find_owner/${petId}`
        );
        this.fetchPetList();
