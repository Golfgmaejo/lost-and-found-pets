            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field v-model="editedItem.category" label="ประเภท"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6">
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field v-model="editedItem.lost_date" label="วันที่หาย"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6">
                    <v-text-field v-model="editedItem.time" label="เวลาที่หาย"></v-text-field>
                  </v-col>
                  <v-col cols="12">
                  ...
                  <v-col cols="12">
                    <v-text-field v-model="editedItem.reward" label="รางวัล"></v-text-field>
                  </v-col>
                  <v-col cols="12">
                    <v-file-input
                      label="เลือกรูปภาพ"
...
const fetchPets = async () => {
  try {
    const response = await axios.get('http://localhost:5000/api/lost_pet/getAll_lost_pets');
