<template>
  <v-container>
    <h1 class="text-portfolio-title">ประกาศหาเจ้าของ</h1>
...
export default {
  ...
  methods: {
    ...
    logSelectedDate(selectedDate) {
      if (selectedDate) {
        this.form.findownerDate = selectedDate;
        this.menuDate = false;
      }
    },
